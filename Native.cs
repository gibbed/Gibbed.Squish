...
namespace Gibbed.Squish
{
	public sealed class Native
	{
		...
		{
			[DllImport("squish32.dll", EntryPoint = "SquishCompressImage", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport("squish32.dll", EntryPoint = "SquishDecompressImage", CallingConvention = CallingConvention.Cdecl)]
		...
		{
            [DllImport("squish64.dll", EntryPoint = "SquishCompressImage", CallingConvention = CallingConvention.Cdecl)]
            internal static extern void CompressImage([MarshalAs(UnmanagedType.LPArray)] byte[] rgba, int width, int height, [MarshalAs(UnmanagedType.LPArray)] byte[] blocks, int flags);

            [DllImport("squish64.dll", EntryPoint = "SquishDecompressImage", CallingConvention = CallingConvention.Cdecl)]
            internal static extern void DecompressImage([MarshalAs(UnmanagedType.LPArray)] byte[] rgba, int width, int height, [MarshalAs(UnmanagedType.LPArray)] byte[] blocks, int flags);
		}
